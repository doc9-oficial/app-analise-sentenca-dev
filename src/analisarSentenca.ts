...
interface AnalisarSentencaParams {
  parametro: string;
  filtro?: string;
}

async function analisarSentenca(params: AnalisarSentencaParams): Promise<void> {
  try {
    ...
    console.log(`Executando analisarSentenca com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Analisa sentença para identificar pontos recorríveis concluído com sucesso",
      resultado: {
...
export default analisarSentenca;
