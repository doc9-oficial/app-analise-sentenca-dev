...
interface ResumirSentencaParams {
  parametro: string;
  filtro?: string;
}

async function resumirSentenca(params: ResumirSentencaParams): Promise<void> {
  try {
    ...
    console.log(`Executando resumirSentenca com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Gera resumo técnico de sentença concluído com sucesso",
      resultado: {
...
export default resumirSentenca;
